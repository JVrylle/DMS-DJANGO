# Generated by Django 5.1.7 on 2025-05-19 14:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], default=None, max_length=10)),
                ...
                ('mi_isgoodhealth', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=10)),
                ('mi_is_under_medical_treatment', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=10)),
                ('mi_is_under_medical_treatment_followup', models.CharField(blank=True, max_length=255, null=True)),
                ('mi_is_serious_illness', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=10)),
                ('mi_is_serious_illness_followup', models.CharField(blank=True, max_length=255, null=True)),
                ('mi_is_hospitalized', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=10)),
                ('mi_is_hospitalized_followup', models.CharField(blank=True, max_length=255, null=True)),
                ('mi_is_taking_prescription', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=10)),
                ('mi_is_taking_prescription_followup', models.CharField(blank=True, max_length=255, null=True)),
                ('mi_is_using_tobacco', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=10)),
                ('mi_is_using_dangerous_drugs', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=10)),

# Generated by Django 5.1.3 on 2025-05-21 15:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Scheduled', 'Scheduled'), ('Completed', 'Completed'), ('Cancelled', 'Cancelled'), ('No Show', 'No Show')], db_index=True, default='Scheduled', max_length=20)),
                ('purpose', models.CharField(choices=[('Checkup', 'Checkup'), ('Cleaning', 'Cleaning'), ('Filling', 'Filling'), ('Extraction', 'Extraction'), ('Crown', 'Crown'), ('Root Canal', 'Root Canal'), ('Adjust', 'Adjust'), ('Whitening', 'Whitening'), ('Bonding (Braces)', 'Bonding (Braces)'), ('Others', 'Others')], max_length=50)),

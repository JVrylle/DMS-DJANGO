...
SECRET_KEY = 'django-insecure-c1d52v!rf&)myel*390ihg$6t*t2#ix=&4(fl6&6vm8#d2turr'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dental.context_processors.user_context',
            ],
        },
    },
]
...
# For production (real emails using Gmail SMTP)
